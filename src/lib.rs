...
#[derive(Debug)]
pub struct SmsMarketingProcessor {
    verbose: bool,
    processed_count: usize,
}

impl SmsMarketingProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting SmsMarketing processing");
    
    let mut processor = SmsMarketingProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = SmsMarketingProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = SmsMarketingProcessor::new(false);
